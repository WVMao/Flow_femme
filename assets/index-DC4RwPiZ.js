(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function l(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(e){if(e.ep)return;e.ep=!0;const s=l(e);fetch(e.href,s)}})();let J=localStorage.getItem("lastView")||"calendar",E=new Date().getMonth(),D=new Date().getFullYear();const X=[{id:"1",name:"Flow",age:26,cycleLength:28,periodLength:5,targetWeight:60,waterGoal:8,sleepGoal:8,lastPeriodDate:new Date(new Date().setDate(new Date().getDate()-25)).toISOString().split("T")[0],isSecurityEnabled:!1,language:"fr"}];let k=JSON.parse(localStorage.getItem("profiles")||JSON.stringify(X)),y=localStorage.getItem("activeProfileId")||k[0].id,n=k.find(t=>t.id===y)||k[0];const j={fr:{nav:{calendar:"Calendrier",health:"Santé",tips:"Conseils",profile:"Profil"},titles:{calendar:"Mon Calendrier 📅",health:"Santé & IMC ⚖️",tips:"Conseils Santé 💡",profile:"Votre Profil 🌸",report:"Rapport Santé"},symptoms:["Crampes","Maux de tête","Acné","Ballonnements","Fatigue","Seins sensibles","Bas du dos"],moods:["Heureuse","Calme","Irritable","Sensible","Épuisée","Anxieuse"],phases:{menstrual:"Règles",follicular:"Folliculaire",ovulatory:"Ovulation",luteal:"Lutéale"},ui:{save:"Enregistrer",cancel:"Annuler",edit:"Modifier",delete:"Supprimer",addProfile:"Ajouter un profil",switchProfile:"Changer de Profil",security:"Sécurité",pinProtect:"Protéger par PIN",exportJSON:"Exporter (JSON)",exportPDF:"📄 Générer Rapport (PDF)",clearData:"Supprimer tout",createProfile:"Créer le profil",today:"Aujourd'hui",fertile:"Fertile",periodStart:"Prochaines Règles",water:"Hydratation 💧",sleep:"Sommeil 🌙",sleepQuality:"Qualité",moodChart:"Analyse d'Humeur 📊",weightChart:"Suivi du Poids",bmiCalc:"Calculateur d'IMC",height:"Taille (cm)",weight:"Poids (kg)",calc:"Calculer & Sauvegarder",goalWeight:"Objectif Poids",current:"Actuel",none:"Aucune mesure enregistrée",journal:"Journal du",flow:"Flux",symptomLabel:"Symptômes",moodLabel:"Humeur",nutrition:"Nutrition 🥗",notes:"Notes",breakfast:"☕ Petit déjeuner",lunch:"🍲 Déjeuner",dinner:"🍝 Dîner",snack:"🍎 Collation",confirmPin:"Entrez votre PIN",createPin:"Créer PIN",setupPin:"Configurer PIN",lang:"Langue / Language",cloud:"Sauvegarde Cloud ☁️",syncNow:"🔄 Synchroniser",lastSync:"Dernière synchro",synced:"À jour",notSynced:"Non synchronisé",restore:"📥 Restaurer",confirmRestore:"Cela remplacera vos données actuelles par la sauvegarde. Continuer ?",syncing:"Synchronisation...",restoring:"Restauration...",successSync:"Données sauvegardées en ligne ! ✅",successRestore:"Données restaurées ! ✅",profileUpdated:"Profil mis à jour !",disablePinConfirm:"Désactiver PIN ?",setupPinTitle:"Créer PIN",predictions:"Prévisions",waterGoalAchieved:"🎉 Objectif atteint ! Bravo !",waterGoalContinue:"Continuez comme ça !",sleepQualityBad:"Mauvais",sleepQualityAverage:"Moyen",sleepQualityGood:"Bon",sleepGoal:"Objectif",flowNone:"Aucun",flowLight:"Léger",flowMedium:"Moyen",flowHeavy:"Abondant",breakfastPlaceholder:"Ex: Avoine, Fruits...",lunchPlaceholder:"Ex: Salade Quinoa...",dinnerPlaceholder:"Ex: Soupe, Légumes...",snackPlaceholder:"Ex: Amandes, Yaourt..."}},en:{nav:{calendar:"Calendar",health:"Health",tips:"Tips",profile:"Profile"},titles:{calendar:"My Calendar 📅",health:"Health & BMI ⚖️",tips:"Health Tips 💡",profile:"Your Profile 🌸",report:"Health Report"},symptoms:["Cramps","Headache","Acne","Bloating","Fatigue","Tender Breasts","Low Back Pain"],moods:["Happy","Calm","Irritable","Sensitive","Exhausted","Anxious"],phases:{menstrual:"Menstrual",follicular:"Follicular",ovulatory:"Ovulation",luteal:"Luteal"},ui:{save:"Save",cancel:"Cancel",edit:"Edit",delete:"Delete",addProfile:"Add Profile",switchProfile:"Switch Profile",security:"Security",pinProtect:"PIN Protection",exportJSON:"Export (JSON)",exportPDF:"📄 Generate Report (PDF)",clearData:"Clear All Data",createProfile:"Create Profile",today:"Today",fertile:"Fertile",periodStart:"Next Period",water:"Hydration 💧",sleep:"Sleep 🌙",sleepQuality:"Quality",moodChart:"Mood Analysis 📊",weightChart:"Weight Tracker",bmiCalc:"BMI Calculator",height:"Height (cm)",weight:"Weight (kg)",calc:"Calculate & Save",goalWeight:"Weight Goal",current:"Current",none:"No measurement recorded",journal:"Journal for",flow:"Flow",symptomLabel:"Symptoms",moodLabel:"Mood",nutrition:"Nutrition 🥗",notes:"Notes",breakfast:"☕ Breakfast",lunch:"🍲 Lunch",dinner:"🍝 Dinner",snack:"🍎 Snack",confirmPin:"Enter PIN",createPin:"Create PIN",setupPin:"Setup PIN",lang:"Langue / Language",cloud:"Cloud Backup ☁️",syncNow:"🔄 Sync Now",lastSync:"Last Synced",synced:"Up to date",notSynced:"Not synced",restore:"📥 Restore",confirmRestore:"This will replace your current data with the backup. Continue?",syncing:"Syncing...",restoring:"Restoring...",successSync:"Data saved to cloud! ✅",successRestore:"Data restored! ✅",profileUpdated:"Profile updated!",disablePinConfirm:"Disable PIN?",setupPinTitle:"Create PIN",predictions:"Predictions",waterGoalAchieved:"🎉 Goal reached! Well done!",waterGoalContinue:"Keep going!",sleepQualityBad:"Bad",sleepQualityAverage:"Average",sleepQualityGood:"Good",sleepGoal:"Goal",flowNone:"None",flowLight:"Light",flowMedium:"Medium",flowHeavy:"Heavy",breakfastPlaceholder:"Ex: Oatmeal, Fruits...",lunchPlaceholder:"Ex: Quinoa Salad...",dinnerPlaceholder:"Ex: Soup, Veggies...",snackPlaceholder:"Ex: Almonds, Yogurt..."}}},i=t=>{const a=n.language||"fr",l=t.split(".");let o=j[a];for(const e of l)o=o?.[e];return o||t},Z=()=>j[n.language||"fr"].symptoms,ee=()=>j[n.language||"fr"].moods;let v=JSON.parse(localStorage.getItem(`bmiHistory_${y}`)||"[]"),c=JSON.parse(localStorage.getItem(`dailyLogs_${y}`)||"[]");const te=[{title:"Nutrition Menstruelle",content:"Privilégiez les aliments riches en fer et magnésium.",category:"nutrition",phase:"menstrual"},{title:"Énergie Folliculaire",content:"C'est le moment idéal pour des entraînements cardio intenses.",category:"sport",phase:"follicular"},{title:"Bien-être Holistique",content:"L'ovulation est propice à la créativité.",category:"wellbeing",phase:"ovulatory"},{title:"Phase Lutéale",content:"Priorisez le repos et les activités douces comme le Yoga.",category:"sport",phase:"luteal"}],P=document.getElementById("app-content"),F=document.getElementById("view-title"),_=document.querySelectorAll(".nav-item"),q=document.getElementById("current-date"),ae=()=>{if(q){const t=new Date;q.textContent=t.toLocaleDateString("fr-FR",{weekday:"long",day:"numeric",month:"long"})}},Q=(t="Entrez votre PIN",a="verify",l)=>{const o=document.createElement("div");o.className="lock-screen";let e="";const s=()=>{o.querySelectorAll(".pin-dot").forEach((d,r)=>d.classList.toggle("filled",r<e.length))};o.innerHTML=`
  ...
  `,document.body.appendChild(o),o.querySelectorAll(".num-btn").forEach(d=>{d.addEventListener("click",()=>{const r=d.getAttribute("data-val");r==="del"?e=e.slice(0,-1):r&&e.length<4&&(e+=r),s(),e.length===4&&setTimeout(()=>{a==="verify"?e===n.pin?(o.classList.add("out"),setTimeout(()=>{o.remove(),l&&l(e)},400)):(e="",s(),alert("PIN Incorrect")):l&&(l(e),o.remove())},200)})}),document.getElementById("cancel-pin")?.addEventListener("click",()=>o.remove())},A=()=>{if(!P)return;F.textContent=`Bonjour, ${n.name} ✨`;const t=n.language==="en"?["January","February","March","April","May","June","July","August","September","October","November","December"]:["Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre"],a=new Date(D,E,1).getDay(),l=new Date(D,E+1,0).getDate(),o=a===0?6:a-1,e=ce(n.lastPeriodDate,n.cycleLength,n.periodLength),s=e.nextPeriod,d=e.nextPeriodEnd,r=n.language==="en"?"en-US":"fr-FR",m={day:"numeric",month:"long"},p=s?s.toLocaleDateString(r,m):i("ui.unknown"),f=e.fertileWindowStart?`${e.fertileWindowStart.toLocaleDateString(r,{day:"numeric"})} - ${e.fertileWindowEnd?.toLocaleDateString(r,m)}`:i("ui.unknown"),u=new Date().toISOString().split("T")[0],$=c.find(g=>g.date===u)||{waterIntake:0},I=n.waterGoal||8,b=$.waterIntake||0,S=$.sleepHours||7,L=$.sleepQuality||null;P.innerHTML=`
    <div class="card" style="background: linear-gradient(135deg, white, var(--bg-app));">
      ...
      <div class="calendar-container">
        ...
        ${Array.from({length:l},(g,h)=>{const w=h+1,x=new Date(D,E,w),C=`${D}-${(E+1).toString().padStart(2,"0")}-${w.toString().padStart(2,"0")}`,M=new Date().toDateString()===x.toDateString(),K=c.some(O=>O.date===C);let T=!1,W=!1,G=!1;if(s&&d&&(x>=s&&x<=d&&(T=!0),x>=e.fertileWindowStart&&x<=e.fertileWindowEnd&&(W=!0),x.toDateString()===e.ovulation?.toDateString()&&(G=!0)),n.lastPeriodDate){const O=new Date(n.lastPeriodDate),R=new Date(O);R.setDate(O.getDate()+n.periodLength-1),x>=O&&x<=R&&(T=!0)}return`
            <div class="cal-day ${T?"period":""} ${W?"fertile":""} ${G?"ovulation":""} ${M?"today":""}" data-day="${w}">
              ${w}
  ...
  `,document.getElementById("prev-month")?.addEventListener("click",()=>{E--,E<0&&(E=11,D--),A()}),document.getElementById("next-month")?.addEventListener("click",()=>{E++,E>11&&(E=0,D++),A()}),document.getElementById("log-period-btn")?.addEventListener("click",()=>z(new Date().getDate())),document.querySelectorAll(".cal-day").forEach(g=>{g.addEventListener("click",()=>{const h=Number(g.getAttribute("data-day"));h&&z(h)})}),document.querySelectorAll(".water-glass").forEach(g=>{g.addEventListener("click",()=>{const h=Number(g.getAttribute("data-idx"));let w=h+1;b===w&&(w=h);const x=c.findIndex(M=>M.date===u),C=x>-1?{...c[x],waterIntake:w}:{date:u,symptoms:[],moods:[],waterIntake:w};x>-1?c[x]=C:c.push(C),localStorage.setItem(`dailyLogs_${y}`,JSON.stringify(c)),A()})});const H=(g,h)=>{const w=c.findIndex(M=>M.date===u),C={...w>-1?c[w]:{date:u,symptoms:[],moods:[]},sleepHours:g,sleepQuality:h};w>-1?c[w]=C:c.push(C),localStorage.setItem(`dailyLogs_${y}`,JSON.stringify(c)),A()};document.getElementById("sleep-minus")?.addEventListener("click",()=>{S>0&&H(S-.5,L)}),document.getElementById("sleep-plus")?.addEventListener("click",()=>{S<24&&H(S+.5,L)}),document.querySelectorAll(".quality-opt").forEach(g=>{g.addEventListener("click",()=>{const h=g.getAttribute("data-q");H(S,h)})})},z=t=>{const a=`${D}-${(E+1).toString().padStart(2,"0")}-${t.toString().padStart(2,"0")}`,l=c.find(r=>r.date===a)||{date:a,symptoms:[],moods:[],flow:"none",meals:[]},o=l.meals||[],e=r=>o.find(m=>m.type===r)?.description||"",s=n.language==="en"?"en-US":"fr-FR",d=document.createElement("div");d.className="modal-overlay show",d.innerHTML=`
  ...
  `,document.getElementById("calc-bmi-btn")?.addEventListener("click",re),ne(),ie()},ie=()=>{const t=document.getElementById("mood-chart");if(!t)return;const a=new Date,l=[];for(let p=6;p>=0;p--){const f=new Date(a);f.setDate(f.getDate()-p);const u=f.toISOString().split("T")[0],$=c.find(S=>S.date===u);let I=0;if($&&$.moods.length>0){const S={Heureuse:5,Calme:4,Sensible:3,Anxieuse:2,Irritable:1,Épuisée:0},L=n.language==="en"?$.moods.map(g=>j.fr.moods[j.en.moods.indexOf(g)]):$.moods;I=L.reduce((g,h)=>g+(S[h]||2.5),0)/L.length}const b=n.language==="en"?"en-US":"fr-FR";l.push({date:f.toLocaleDateString(b,{weekday:"short"}),score:I})}const o=t.clientWidth,e=200,s=30,d=p=>p/(l.length-1)*(o-2*s)+s,r=p=>e-(p/5*(e-2*s)+s);let m=`M ${d(0)} ${r(l[0].score)}`;for(let p=1;p<l.length;p++)m+=` L ${d(p)} ${r(l[p].score)}`;t.innerHTML=`
    ...
    `},ne=()=>{const t=document.getElementById("weight-chart");if(!t||v.length<2){t&&(t.innerHTML='<p style="text-align:center; color:var(--text-muted); margin-top:80px;">Saisissez au moins 2 mesures.</p>');return}const a=30,l=t.clientWidth,o=200,e=v.slice(-7),s=Math.min(...e.map(u=>u.weight))-2,d=Math.max(...e.map(u=>u.weight))+2,r=u=>u/(e.length-1)*(l-2*a)+a,m=u=>o-((u-s)/(d-s)*(o-2*a)+a);let p=`M ${r(0)} ${m(e[0].weight)}`,f=`M ${r(0)} ${o} L ${r(0)} ${m(e[0].weight)}`;for(let u=1;u<e.length;u++)p+=` L ${r(u)} ${m(e[u].weight)}`,f+=` L ${r(u)} ${m(e[u].weight)}`;f+=` L ${r(e.length-1)} ${o} Z`,t.innerHTML=`
    <svg class="chart-svg" viewBox="0 0 ${l} ${o}">
      ...
      ${e.map((u,$)=>`<circle class="chart-dot" cx="${r($)}" cy="${m(u.weight)}" r="4" /><text class="chart-label" x="${r($)}" y="${o-5}" text-anchor="middle">${u.date.split("/")[0]}</text>`).join("")}
    </svg>
  ...
  `;const t=a=>{n.language=a,N(),location.reload()};document.getElementById("lang-fr")?.addEventListener("click",()=>t("fr")),document.getElementById("lang-en")?.addEventListener("click",()=>t("en")),document.getElementById("save-profile-btn")?.addEventListener("click",()=>{n.cycleLength=Number(document.getElementById("p-cycle").value),n.periodLength=Number(document.getElementById("p-period").value),n.targetWeight=Number(document.getElementById("p-weight").value),n.waterGoal=Number(document.getElementById("p-water").value),n.sleepGoal=Number(document.getElementById("p-sleep").value);const a=document.getElementById("p-last").value;a&&(n.lastPeriodDate=a);const l=k.findIndex(o=>o.id===y);l>-1&&(k[l]=n),N(),alert(i("ui.profileUpdated")+" ✅"),A()}),document.getElementById("sync-btn")?.addEventListener("click",()=>{const a=document.getElementById("sync-btn"),l=a.textContent;a.textContent=i("ui.syncing"),a.disabled=!0,setTimeout(()=>{const o=new Date;n.lastSynced=o.toISOString(),localStorage.setItem(`cloud_backup_${y}`,JSON.stringify({profile:n,logs:c,bmi:v})),N(),a.textContent=l,a.disabled=!1,alert(i("ui.successSync")),V()},1500)}),document.getElementById("restore-btn")?.addEventListener("click",()=>{if(!confirm(i("ui.confirmRestore")))return;const a=document.getElementById("restore-btn"),l=a.textContent;a.textContent=i("ui.restoring");const o=localStorage.getItem(`cloud_backup_${y}`);o?setTimeout(()=>{const e=JSON.parse(o);c=e.logs||[],v=e.bmi||[],n={...n,...e.profile},localStorage.setItem(`dailyLogs_${y}`,JSON.stringify(c)),localStorage.setItem(`bmiHistory_${y}`,JSON.stringify(v)),N(),a.textContent=l,alert(i("ui.successRestore")),location.reload()},1500):(alert("Aucune sauvegarde trouvée / No backup found."),a.textContent=l)}),document.getElementById("add-profile-btn")?.addEventListener("click",le),document.getElementById("pin-toggle")?.addEventListener("click",()=>{n.isSecurityEnabled?confirm(i("ui.disablePinConfirm"))&&(n.isSecurityEnabled=!1,n.pin=void 0,N(),B("profile")):Q(i("ui.setupPin"),"setup",a=>{n.isSecurityEnabled=!0,n.pin=a,N(),B("profile")})}),document.getElementById("export-pdf-btn")?.addEventListener("click",de),document.getElementById("export-data-btn")?.addEventListener("click",()=>{const a={profile:n,bmiHistory:v,dailyLogs:c},l=new Blob([JSON.stringify(a,null,2)],{type:"application/json"}),o=URL.createObjectURL(l),e=document.createElement("a");e.href=o,e.download=`flowfit_data_${n.name}.json`,e.click()}),document.getElementById("clear-data-btn")?.addEventListener("click",()=>{confirm("ATTENTION: Cela effacera toutes les données de ce profil. Continuer ?")&&(localStorage.removeItem(`bmiHistory_${y}`),localStorage.removeItem(`dailyLogs_${y}`),v=[],c=[],alert("Données effacées."),B("profile"))})},le=()=>{const t=document.createElement("div");t.className="modal-overlay show",t.innerHTML=`
    <div class="modal-sheet">
  ...
  `,document.body.appendChild(t),document.getElementById("create-profile-btn")?.addEventListener("click",()=>{const a=document.getElementById("new-name").value,l=Number(document.getElementById("new-target").value);if(a&&l){const o={id:Date.now().toString(),name:a,age:25,cycleLength:28,periodLength:5,targetWeight:l,isSecurityEnabled:!1};k.push(o),N(),t.remove(),Y(o.id)}})},Y=t=>{y=t,localStorage.setItem("activeProfileId",t),n=k.find(a=>a.id===t),v=JSON.parse(localStorage.getItem(`bmiHistory_${t}`)||"[]"),c=JSON.parse(localStorage.getItem(`dailyLogs_${t}`)||"[]"),B("calendar")};window.switchProfile=Y;const N=()=>localStorage.setItem("profiles",JSON.stringify(k)),re=()=>{const t=Number(document.getElementById("h-height").value)/100,a=Number(document.getElementById("h-weight").value);t>0&&a>0&&(v.push({date:new Date().toLocaleDateString("fr-FR"),weight:a,height:t*100,bmi:a/(t*t)}),localStorage.setItem(`bmiHistory_${y}`,JSON.stringify(v)),U())},se=t=>t<18.5?"Insuffisant":t<25?"Normal":t<30?"Surpoids":"Obésité",de=()=>{const t=window.open("","_blank");if(!t)return alert("Veuillez autoriser les pop-ups pour générer le rapport.");const a=c.sort((o,e)=>e.date.localeCompare(o.date)).map(o=>`
      <tr>
          <td>${o.date}</td>
          <td>${o.flow||"-"}</td>
